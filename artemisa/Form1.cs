    ...
    public partial class Form1 : Form
    {
        ...
        public void _detallesPuertos(string _host)
        {
            ...
            int[] _puertosConocidos = { 1,5,7,9,11,13,17,18,19,20,21,22,23,25,37,39,42,43,49,50,53,63,66,67,68,69,70,79,80,88,95,101,107,109,110,111,113,115,117,119,
                                ...
                                435,443,444,445,465,500,512,513,514,515,520,587,591,631,666,690,993,995,1024,1080,1337,1352,1433,1434,1494,1512,1521,1701,1720,1723,1761,
            ...
            for (int i = 1; i < 184; i++)
            {
                ...
                //Console.Read();
                {
                    try
                    {
                        ...
                        else if (_puertosConocidos[i] == 111)
                        {
